...
class ComentarioController
{
     ...
     * Constructor.
     *
     * @param ComentarioService|null $comentarioService Servicio (inyección de dependencias).
     */
     ...
     * Solo usuarios logueados (autor o admin).
     */
    ...
    /**
     * Obtener y sanitizar datos de creación de comentario.
     *
    ...
    /**
     * Renderizar lista de comentarios en HTML.
     *
     * @param array $comentarios Array de WP_Post de comentarios.
    ...
    /**
     * Renderizar un item de comentario.
     *
     * @param array $datos Datos formateados del comentario.
     */
...
<?php
    ...
    /**
     * Enviar respuesta JSON para lista de comentarios.
     *
     * @param bool   $noComentarios Si no hay comentarios.
     * @param string $html          HTML a enviar.
     * @param bool   $hayMas        Si hay más páginas.
     */
