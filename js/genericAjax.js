...
/*
cuando en verificarPost if data success necesita hace algo extra
borrar el contenido de 
<div class="verificarPost" data-post-id="255493 style=" cursor:="" pointer;"="" data-listener-added="true" style="cursor: pointer;">  (aqui adentro hay un svg)
