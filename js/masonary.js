// Inicializa Masonry
function iniciarMasonry(selector, columnWidth, gutter) {
    // Verifica si ya existe una instancia de Masonry en el elemento
    var existingMasonry = Masonry.data(document.querySelector(selector));
    if (existingMasonry) {
        // Destruye la instancia existente
        existingMasonry.destroy();
    }

    // Crea una nueva instancia de Masonry
    var msnry = new Masonry(document.querySelector(selector), {
        itemSelector: 'li',
...
// Ejemplo de uso:
var masonryInstance; // Variable para guardar la instancia de Masonry

// Llamada inicial
masonryInstance = iniciarMasonry('.clase-imagenesPerfil', 200, 10);

// Para reiniciarlo (por ejemplo, después de añadir más imágenes o al redimensionar la ventana)
function reiniciarMasonry() {
    masonryInstance = iniciarMasonry('.clase-imagenesPerfil', 200, 10);
}

// Ejemplo de cómo podrías usarlo al redimensionar la ventana:
