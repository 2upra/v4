function createSubmenu(triggerSelector, submenuIdPrefix, adjustTop = 0, adjustLeft = 0) {
    ...
    triggers.forEach(trigger => {
        if (trigger.dataset.submenuInitialized) {
            //console.log(`[createSubmenu] Trigger ya inicializado: ${trigger.id || trigger.dataset.postId || "default"}`);
            return;
        }
...
function initializeStaticMenus() {
    ...
    createSubmenu(".fotoperfilsub", "fotoperfilsub", 30, 150 )
}
