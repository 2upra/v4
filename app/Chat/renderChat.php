...
function renderChat()
{
    ob_start();
    ?>
    <div class="bloque modal bloqueChat" data-user-id="" style="display: none;">
        <div class="infoChat">
            ...
            <div class="botoneschat">
                <button class="minizarChat"><?php echo $GLOBALS['minus']; ?></button>
                <button class="cerrarChat"><?php echo $GLOBALS['cancelicon']; ?></button>
            </div>
        </div>
