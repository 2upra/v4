...
// Refactor(Org): Funcion infoUsuario() y hook AJAX movidos a app/Services/UserService.php
...
// Refactor(Org): Función procesarMensaje() movida desde app/Chat/Galle2v.php
function procesarMensaje($request)
{
    ...
    try {
        ...
        // Refactor: guardarMensaje() está en este mismo archivo (ChatService.php)
