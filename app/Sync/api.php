...
function my_custom_api_endpoints() {
    // Your API registration code here
...
// Other functions here (check_electron_app_header, get_user_audio_downloads, serve_download)
...
add_action('plugins_loaded', 'my_custom_api_endpoints');