...
?>
    ...
    <div class="C1">
        ...
        <div class="X1">
            ...
            <p class="XX2"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/401040980_2573929656119046_4305007231577328267_n.jpg')); ?>" alt="1ndoryü"></p>
        </div>
        ...
        <div class="X3">
            ...
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/mockup1.jpg')); ?>" alt="1ndoryü"></p>
            ...
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/2@2000x-100.jpg')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/3@2000x-100.jpg')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/33.png')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/55.png')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/5@2000x-100.jpg')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/6@2000x-100.jpg')); ?>" alt="1ndoryü"></p>
            <p class="XX4"><img src="<? echo esc_url(site_url('/wp-content/uploads/2024/05/7@2000x-100.jpg')); ?>" alt="1ndoryü"></p>
        </div>
    </div>
