<?php
/**
 * Componente de vista para renderizar el contenido principal del perfil de música.
 */

// Refactor(Exec): Moved function custom_user_profile_shortcode_music() and its hook from app/Perfiles/perfilmusic.php
