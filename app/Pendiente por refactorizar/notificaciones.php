...
//necesito que esto si el usuario actual si la ultima notificación no tiene la meta visto, entonces agreggar este color al fill #d43333 , el post type es 'post_type'   => 'notificaciones', tambien tiene que soportar ajax para que cuando reciba una petición de verificación para ver si hay noti sin leer (Haz eficiento y el)
